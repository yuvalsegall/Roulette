...
public class XMLGame {
    ...
    public static Game getXMLGame(File XMLFile) throws JAXBException, BadParamsException {
        try {
            Game myGame;
            ...
            myGame = new Game(new Game.GameDetails(gameName, minWages, maxWages, tableType, initalSumOfMoney, players));
